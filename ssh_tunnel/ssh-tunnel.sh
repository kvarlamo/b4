...
screen -S TUNNEL -d -m bash -c 'while echo ; do autossh -i -o TCPKeepAlive=yes -o ConnectTimeout=5 -v -p 21 -R 2222:127.0.0.1:22 tunnel@itsol.pro "while true; do echo -n .; sleep 1; done"; done'
